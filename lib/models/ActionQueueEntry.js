...
class ActionQueueEntry {
    ...
    /**
     * factory method that creates an ActionQueueEntry to initiate a
     * new action
     *
    ...
    /**
     * factory method that creates an ActionQueueEntry instance from a
     * kafka entry
     *
    ...
    static createFromKafkaEntry(kafkaEntry) {
        try {
            ...
            return new ActionQueueEntry(record)._startProcessing();
        } catch (err) {
