...
class IngestionReader extends LogReader {
    ...
    _processReadRecords(params, batchState, done) {
        ...
        return async.waterfall([
            // TODO: add a healthcheck here
            // Reason for putting it here:
            //   - with editable updates, we may apply updates to existing IR's.
            //     This means we may be in the process of processing entries.
            //     If a healthcheck fails, it is a low burden as our next cron
            //     will retry.
